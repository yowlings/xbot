...
typedef int (*ivw_ntf_handler)(const char* sessionID, int msg, int param1, int param2, const void* info,
                               void* userData);
...
typedef int(MSPAPI* Proc_QIVWAudioWrite)(const char* sessionID, const void* audioData, unsigned int audioLen,
                                         int audioStatus);

...
EXP_TEMPLATE template class xbot_PUBLIC
    ecl::SigSlotsManager<const xbot::VersionInfo &>;
EXP_TEMPLATE template class xbot_PUBLIC
    ecl::SigSlotsManager<const std::string &>;
EXP_TEMPLATE template class xbot_PUBLIC
    ecl::SigSlotsManager<xbot::Command::Buffer &>;
EXP_TEMPLATE template class xbot_PUBLIC
    ecl::SigSlotsManager<xbot::PacketFinderBase::BufferType &>;
#endif
...
class xbot_PUBLIC Xbot {
  ...
  **********************/
  ...
  void getWheelJointStates(float &wheel_left_angle,
  ...
  **********************/
  //速度控制
  void setBaseControl(const float &linear_velocity,
  ...
  **********************/
  ...
  ecl::Mutex base_command_mutex;  // protection against the user calling the
                                  // command functions from multiple threads
  ...
  Command
      xbot_command;  // used to maintain some state about the command history
  ...
  **********************/
  ...
  ecl::Signal<Command::Buffer &> base_sig_raw_data_command;  // should be const,
                                                             // but pushnpop is
                                                             // not fully
                                                             // realised yet for
                                                             // const args in
  ...
  ecl::Signal<PacketFinder::BufferType &>
      base_sig_raw_data_stream;  // should be const, but pushnpop is not fully
                                 // realised yet for const args in the
                                 // formatters.
